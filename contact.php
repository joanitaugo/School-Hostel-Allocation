...
<link rel="shortcut icon" type="images/jpg" href="images/unilogo.jpg">
</head>
<body>
	...
	<div id="header">
		<div class="container">
			...
			<div class="left-side">
				...
				<!-- Logo -->
				<div id="logo">
					<a href="index-2.html"><img src="images/unilogo.jpg" alt=""></a>
				</div>
			...
			<div class="contact-location-info margin-bottom-50">
				<div class="contact-address">
					<ul>
						...
						<li>Ignatius Ajuru University of Education<br>
							Port Harcort, Rivers State,<br>
							Nigeria.</li>
						<li> P.M.B 5047<br> 
							https://iauoe.edu.ng<br>
							Cisco Academy, ID 20040066</li>
						<li><a href="#"></a></li>
						<li>
...
<div id="footer">
							...
							<div class="footer-row">
								<div class="footer-row-inner">
									<ul class="footer-social-links">
										...
										<li>
											<a href="https://www.instagram.com//" title="Instagram" data-tippy-placement="bottom" data-tippy-theme="light">
	...
	<div class="footer-bottom-section">
		<div class="container">
			<div class="row">
				<div class="col-xl-12">
					© 2021 <strong>Ignatius Ajuru University of Education</strong>. All Rights Reserved.
				</div>
			</div>
		</div>
	</div>
